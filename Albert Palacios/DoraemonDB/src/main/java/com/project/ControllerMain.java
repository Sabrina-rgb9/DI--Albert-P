...
public class ControllerMain {
    ...
    public void initialize() {
        Image img = new Image(getClass().getResourceAsStream("/assets/images0601/doraemon.jpg"));
        image.setImage(img);
        Image img_character = new Image(getClass().getResourceAsStream("/assets/images0601/nobita.jpg"));
        characterImage.setImage(img_character);
        Image img_serie = new Image(getClass().getResourceAsStream("/assets/images0601/doraemon-serie.jpg"));
        seriesImage.setImage(img_serie);
        Image img_channel = new Image(getClass().getResourceAsStream("/assets/images0601/clan.jpg"));
