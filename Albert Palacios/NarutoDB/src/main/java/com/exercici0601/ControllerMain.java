...
public class ControllerMain implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        image.setImage(new Image(getClass().getResourceAsStream("/assets/images0601/naruto-logo.png")));
    ...
    private void createOptionsMenu() {
        ...
        Label label = new Label("Ninjas");
        label.setMaxHeight(50);
        label.setStyle("-fx-font-size: 18px; -fx-font-weight: bold;");
        HBox.setMargin(label, new Insets(0, 0, 0, 15));

        ImageView img = new ImageView(new Image(getClass().getResourceAsStream("/assets/images0601/naruto-icon.png")));
        img.setFitHeight(40);
        img.setFitWidth(40);
